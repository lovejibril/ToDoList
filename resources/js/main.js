//create a variable with LocalStorage
//if it is not javascript object then convert it to 
//if fals
...
//display old list after refresh
renderTodoList();
...
//add Item into list
//reset document get element id in to blank
// push value (item name )into array list
...
//JSON.stringify(data) = exchange data to string and send it to html
